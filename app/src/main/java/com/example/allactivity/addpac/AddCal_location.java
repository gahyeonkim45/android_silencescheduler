...
import com.search.Item;
import com.search.OnFinishSearchListener;
...
public class AddCal_location extends FragmentActivity implements MapView.MapViewEventListener, MapView.POIItemEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page2_location);
        ...
        mMapView.setDaumMapApiKey(com.example.allactivity.MapApiConst.DAUM_MAPS_ANDROID_APP_API_KEY);
        ...
        mButtonSearch.setOnClickListener(new OnClickListener() { // 검색버튼 클릭 이벤트 리스너
            ...
            public void onClick(View v) {
                ...
                String apikey = com.example.allactivity.MapApiConst.DAUM_MAPS_ANDROID_APP_API_KEY;
                ...
                searcher.searchKeyword(getApplicationContext(), query, latitude, longitude, radius, page, apikey, new OnFinishSearchListener() {
                    ...
                    public void onSuccess(List<Item> itemList) {
                     ...
                     //   putPage2(itemList.get(pointing));
    ...
    private void putPage2(Item item){

        String str = item.title + "%" + item.imageUrl + "%" + item.address + "%" + item.longitude + "%" + item.latitude + "%" + item.id;
